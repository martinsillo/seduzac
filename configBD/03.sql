-- creacion de usuario
CREATE USER IF NOT EXISTS 'seduzac_con'@'localhost' IDENTIFIED BY 'F2AE9469B26199657C279E55B1747';
CREATE USER IF NOT EXISTS 'seduzac_reg'@'localhost' IDENTIFIED BY '3C4F3B8B214AF57424728AEE374CD';
